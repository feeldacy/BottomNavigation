package com.example.bottomnavigatioin
...
import com.example.bottomnavigatioin.databinding.FragmentCheckoutBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            edtAddress.setOnClickListener{
                val action = CheckoutFragmentDirections.actionCheckoutFragmentToAddresFragment()
